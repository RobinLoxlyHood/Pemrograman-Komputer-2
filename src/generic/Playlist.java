...
public class Playlist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        popupTombol.setLabel("");

        addFiles.setText("Add Files");
        addFiles.setActionCommand("jMenuItem");
        ...
        tblPlaylist.setPreferredSize(new java.awt.Dimension(400, 50));
    ...
    private void tblPlaylistMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPlaylistMouseClicked
        ...
        if (evt.getClickCount() == 2 && i !=-1) {
            ...
            +"<tr><td>Extensi</td><td>:</td><td> "+m.getExtention()+"</td></tr>"
            +"</table>"
            +"</body>"
            +"</html>"
            );
    ...
    //Method untuk mengkoleksi semua file mp3 yang dipili
